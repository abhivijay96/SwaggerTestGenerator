...
namespace HK_internship
{
    ...
    public static partial class APIV1Extensions
    {
            ...
            {
                return Task.Factory.StartNew(s => ((IAPIV1)s).ApiValuesByIdGetAsync(id), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
